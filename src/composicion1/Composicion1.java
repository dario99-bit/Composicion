...
public class Composicion1 {
    ...
    public static void main(String[] args) {
           ...
           Libro Controles_Instrumentos= new Libro("Arranque y apague  del motor", 12345296, "Chevrolet", 2000);
            Pagina pagina1= new Pagina ("Arranque y apague el motor, Chevrolet. \n\n"
                    + "Asegurese de que todos los interruptores esten en la posicion desactiva OFF \n", 1);
             Pagina pagina2= new Pagina ("Gire el interruptor de arranque hasta la posicion ON, verifique el correcto funcionamiento "
                     + "de luces y nivel de combustible normal.", 0);
